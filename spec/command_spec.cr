...
describe Tesseract::Ocr::Command do
  it "make options" do
    instance = Tesseract::Ocr::Command.new("./spec/resources/blank.tif", "stdout", {} of Symbol => String)
  ...
  it "join all options to a command" do
    ...
    command.should eq("tesseract ./spec/resources/blank.tif stdout -l eng -c a=1 -c b=2 /tmp/config_path.txt")
  end
end
